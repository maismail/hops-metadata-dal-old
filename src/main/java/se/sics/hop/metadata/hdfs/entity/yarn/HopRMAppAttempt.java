...
public class HopRMAppAttempt {
    ...
    public HopRMAppAttempt(int id, int rmcontextid, int schedulerid, int appmasterserviceid, int appattemptidid, int appsubmissionctx, int containerid, float progress, String host, int rpcport, String origtrackingurl, String proxiedtrackingurl, long starttime, String finalstatus, String diagnostics, String user) {
        this.id = id;

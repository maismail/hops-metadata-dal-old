...
//  public abstract Leader findById(long id) throws StorageException;
  ...
  public abstract HopLeader findByPkey(long id, int partitionKey) throws StorageException;

  public abstract Collection<HopLeader> findAllByCounterGT(long counter) throws StorageException;
  
  public abstract Collection<HopLeader> findAllByIDLT(long id) throws StorageException;
  
  public abstract Collection<HopLeader> findAll() throws StorageException;
  ...
  public abstract void prepare(Collection<HopLeader> removed, Collection<HopLeader> newed, Collection<HopLeader> modified) throws StorageException;
